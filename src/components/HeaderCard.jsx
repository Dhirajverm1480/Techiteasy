  ...
  return (
    <div className="relative min-h-[450px] md:min-h-96">
      ...
      <div className="absolute top-60 md:top-44  page-frame flex flex-col items-center md:items-start">
        <h1 className="text-white md:text-black text-5xl md:text-7xl font-bold font-poppins mb-7">{title}</h1>
        <div className="flex items-center">
            ...
            <Link to={`/${path}`}><p className="text-white md:text-black font-bold" >{pathTitle}</p></Link>
        </div>
      </div>
    </div>
  );
