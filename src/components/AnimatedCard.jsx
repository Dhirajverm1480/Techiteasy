...
export const AnimatedCard = () => {
  ...
  return (
    <div ref={container} className="relative flex justify-center items-end my-10 py-3">
      ...
      <div ref={leftAniImg} className="w-44 md:w-80 h-44 md:h-80 shadow-2xl rounded-xl overflow-hidden -rotate-12">
        <img src={PeopleImg.People_2} alt="" className="w-full h-full" />
      </div>
      <div ref={rightAniImg} className="w-44 md:w-80 h-44 md:h-80 shadow-2xl rounded-xl overflow-hidden rotate-12 ">
